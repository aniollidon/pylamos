...
from sqlalchemy import String, Integer, Text, ForeignKey, Enum, DateTime, Boolean, func
...
class Submission(Base):
    ...
    chat_blocked: Mapped[bool] = mapped_column(Boolean, default=False, server_default="0")
